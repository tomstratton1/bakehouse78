const menuItems = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Scones',
        description: 'Multiple options available: Cheese, Fruit, Cheese and Bacon, and Sundried Tomato and Olive.',
        ingredients: 'Ingredients Placeholder',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Custom-made birthday cakes tailored to your preferences and occasions.',
        ingredients: 'Ingredients Placeholder',
      ...
      },
      {
        ...
        ingredients: 'Ingredients Placeholder',
        image: 'images-wa/special_cake_crop.jpeg',
      },
      {
        title: 'Wedding Cakes',
